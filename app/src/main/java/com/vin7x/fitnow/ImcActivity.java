...
public class ImcActivity extends AppCompatActivity {
        ...
        btnSend.setOnClickListener(view -> {
            ...
            AlertDialog dialog = new AlertDialog.Builder(ImcActivity.this)
                    ...
                    .setPositiveButton(R.string.save, (dialogInterface, which) -> {
                        ...
                        //Executando o banco de dados em uma thread separada, para maior perfomance do App.
                            new Thread(() -> {
                                int updateId = 0;
                    ...
                    .create();
            dialog.show();
            //ESCONDER TECLADO DA JANELA Q ESTARÁ EM EXECUÇÃO
    ...
    @StringRes //Obrigatoriamente arquivo de resourses
